...
export const MODULES = {
  ...
  target: {
    ...
    form: [
      ...
      { name: "periodType", label: "Period Type", type: "select", options: ["Monthly", "Quarterly", "Yearly"], required: true },
      { name: "period", label: "Period (e.g. Aug 2026 / Q2 2026-27 / 2026-27)", required: true },
