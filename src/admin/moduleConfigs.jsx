...
const attach = (v) => v
  ? (String(v).match(/\.pdf$/i)
      ? <span onClick={() => openLightbox(v)} className="link" style={{ cursor: "pointer", color: "var(--accent)", fontWeight: 700 }}>📄 PDF</span>
...
export const MODULES = {
  ...
  enquiry: {
    ...
    columns: [
      ...
      { key: "firm", label: "Firm Name" }, { key: "state", label: "State" }, { key: "city", label: "City" },
    ...
    form: [
      ...
      { name: "leadSource", label: "Lead Source", type: "select", options: ["Direct Call", "IndiaMART", "Biltrax", "LinkedIn", "Reference", "Google AD (Archer)", "Google AD (Eurobond)", "Other"] },
      ...
      { name: "state", label: "State" }, { name: "city", label: "City" }, { name: "pincode", label: "Pincode" },
  ...
  projectProjection: {
    ...
    columns: [
      ...
      { key: "cat_Contractor", label: "Contractor" },
      { key: "cat_Facade Consultant", label: "Facade Consultant" },
      { key: "cat_End User", label: "End User" },
      { key: "productsText", label: "Products" },
  ...
  target: {
    ...
    form: [
      ...
      { name: "achieved", label: "Achieved (₹ for Sales, Sq.Mtr for Specs)", type: "number" },
  ...
  salesEntry: {
    ...
    columns: [
      ...
      { key: "invoice", label: "Invoice / Doc", render: attach },
  ...
  products: {
    ...
    columns: [
      ...
      { key: "grade", label: "Grade" }, { key: "colour", label: "Colour Code" },
    ...
    form: [
      ...
      { name: "grade", label: "Grade (for Quotation dropdown)" }, { name: "colour", label: "Colour Code (for Quotation dropdown)" },
