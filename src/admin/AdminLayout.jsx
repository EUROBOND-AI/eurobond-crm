    ...
    items: [
      {
        label: "Analytics Hub", icon: <LayoutDashboard size={17} />, children: [
          ...
          { label: "Biltrax Dashboard", to: "/admin/dashboards/biltrax" },
        ],
      },
    ...
    items: [
      {
        label: "SFA", icon: <BarChart3 size={17} />, children: [
          ...
          { label: "Tour Report", to: "/admin/sfa/tour-report" },
          { label: "Beat Plan", to: "/admin/sfa/beat-plan" },
          { label: "Biltrax", to: "/admin/sfa/biltrax" },
    ...
    items: [
      {
        label: "Masters", icon: <Boxes size={17} />, children: [
          ...
          { label: "Activity Logs", to: "/admin/master/logs" },
          { label: "Login History", to: "/admin/master/login-history" },
...
function ModuleSearch({ nav }) {
  ...
  const extra = [
    ...
    { title: "Activity Logs", path: "master/logs" },
    { title: "Login History", path: "master/login-history" },
    { title: "Beat Plan", path: "sfa/beat-plan" },
    { title: "Biltrax", path: "sfa/biltrax" },
    { title: "Biltrax Dashboard", path: "dashboards/biltrax" },
  ...
  return (
    <div className="admin-shell">
      ...
      <div className="main-col">
        ...
        <main className="content" style={expired ? { filter: "blur(6px)", pointerEvents: "none", userSelect: "none" } : undefined}>
          <Outlet />
          <FooterNote />
        </main>
      </div>
      {expired && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(10,16,40,.35)", backdropFilter: "blur(3px)", zIndex: 99999, display: "grid", placeItems: "center", padding: 20 }}>
