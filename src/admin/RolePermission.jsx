...
const MODULES = ["Dashboard", "Enquiry Dashboard", "Customers Dashboard", "Target Dashboard", "Project Dashboard", "Attendance", "Attendance Sheet", "Checkin", "Tour Report", "Beat Plan", "Biltrax", "Biltrax Dashboard", "Activity Logs", "Login History", "Expense", "Leave", "Enquiry", "Customers", "Quotation", "Project Projection", "Targets", "Sales to Spec", "Spec to Sales", "Task", "Holidays", "Areas", "Products", "Resources & Links", "Announcement", "Notification", "App Users", "Admin Users", "Role & Permission", "API Keys", "System Health"];
