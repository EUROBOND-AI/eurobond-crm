        ...
        new Thread(new Runnable() {
            @Override public void run() {
                ...
                try {
                    ...
                    /* only skip a fix that carries no useful information at all;
                       a 60 m reading indoors is still a real position, and
                       refusing those left long stretches with no points */
                    if (location.getAccuracy() > 500f && ebLastUploadMs != 0) return;
