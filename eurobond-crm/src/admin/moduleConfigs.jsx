...
export const MODULES = {
  ...
  distributor: {
    path: "customers/distributor", title: "Distributor List", crumb: "Distributor", addLabel: "Add Distributor",
    idPrefix: "CHL", salesView: true, app: true, appLabel: "Distributor", appReadOnly: true,
    tabs: [{ key: "Active", label: "Active" }, { key: "Inactive", label: "Inactive" }],
    tabField: "status",
    columns: [
      { key: "id", label: "Distributor Id", render: link }, { key: "company", label: "Company Name" },
      { key: "account", label: "Account Code" }, { key: "contact", label: "Contact Person" },
      { key: "mobile", label: "Mobile" }, { key: "email", label: "Email" },
      { key: "state", label: "State" }, { key: "city", label: "City" },
      { key: "pincode", label: "Pincode" }, { key: "status", label: "Status", render: pill },
    ],
    form: [
      { name: "company", label: "Company Name", required: true },
      { name: "account", label: "Account Code" },
      { name: "contact", label: "Contact Person" }, { name: "mobile", label: "Mobile" },
      { name: "email", label: "Email" }, { name: "country", label: "Country" },
      { name: "state", label: "State" }, { name: "city", label: "City" },
      { name: "pincode", label: "Pincode" }, { name: "gst", label: "GST Number" },
  ...
  dealer: {
    path: "customers/dealer", title: "Dealer List", crumb: "Dealer", addLabel: "Add Dealer",
    idPrefix: "DLR", salesView: true, app: true, appLabel: "Dealer", appReadOnly: true,
    tabs: [{ key: "Active", label: "Active" }, { key: "Inactive", label: "Inactive" }],
    tabField: "status",
    columns: [
      { key: "id", label: "Dealer Id", render: link }, { key: "firm", label: "Firm Name" },
      { key: "account", label: "Account Code" }, { key: "contact", label: "Contact Person" },
    ...
    form: [
      ...
      { name: "contact", label: "Contact Person" }, { name: "mobile", label: "Mobile" },
      { name: "state", label: "State" }, { name: "city", label: "City" },
      { name: "pincode", label: "Pincode" }, { name: "category", label: "Category" },
      { name: "gst", label: "GST Number" }, { name: "attachment", label: "Attachment", type: "file" },
    ],
  },

  influencer: {
    path: "customers/influencer", title: "Project Influencer List", crumb: "Project Influencer", addLabel: "Add Project Influencer",
    idPrefix: "INF", salesView: true, app: true, appLabel: "Influencer", appReadOnly: true,
    tabs: [{ key: "Active", label: "Active" }, { key: "Inactive", label: "Inactive" }],
    tabField: "status",
    columns: [
      { key: "id", label: "Id", render: link }, { key: "name", label: "Name" },
      { key: "category", label: "Category" }, { key: "firm", label: "Firm" },
      { key: "mobile", label: "Mobile" }, { key: "city", label: "City" },
      { key: "status", label: "Status", render: pill },
    ],
    form: [
      { name: "name", label: "Name", required: true },
      { name: "category", label: "Category", type: "select", options: ["Architect", "Builder", "Contractor", "Fabricator", "End User"], required: true },
      { name: "firm", label: "Firm" }, { name: "mobile", label: "Mobile" },
  ...
  discount: {
    path: "master/discount", title: "Discount Master", crumb: "Discount Master", addLabel: "Add Discount",
    columns: [
      { key: "category", label: "Category" }, { key: "customerType", label: "Customer Type" },
      { key: "series", label: "Product Series" }, { key: "discount", label: "Discount %" },
    ],
    form: [
      { name: "category", label: "Category", required: true },
      { name: "customerType", label: "Customer Type", type: "select", options: ["Distributor", "Dealer"], required: true },
      { name: "series", label: "Product Series" },
